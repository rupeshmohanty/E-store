...
<form action="password_check.php" method="POST" style="width:30%;margin-left: 37%;">
<h3>Change Password</h3>
<input class="form-control" type="password" name="password" placeholder="Old Password"><br>
<input class="form-control" type="password" name="password" placeholder="New Password"><br>
<input class="form-control" type="password" name="password" placeholder="Re-type New Password"><br>
<button type="submit" class="btn btn-primary">Change</button>
</form><br>
<!--Footer-->
<footer class="section footer-classic context-dark bg-image" style="background: #2d3246;margin-top: 15%;">
        <div class="container">
